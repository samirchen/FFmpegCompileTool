...
if [ ! -d "ffmpeg-arm64" ]; then
    cp -R ../ffmpeg ./ffmpeg-arm64
fi

if [ ! -d "ffmpeg-armv7" ]; then
    cp -R ../ffmpeg ./ffmpeg-armv7
fi

if [ ! -d "ffmpeg-i386" ]; then
    cp -R ../ffmpeg ./ffmpeg-i386
fi

if [ ! -d "ffmpeg-x86_64" ]; then
    cp -R ../ffmpeg ./ffmpeg-x86_64
fi
